...
class TestDates(unittest.TestCase):
    ...
    def test_date_subhead(self):
        u = "https://web.archive.org/web/https://www.sun-sentinel.com/community/fl-cn-calendar-events-20211201-20211129-sv3syeeuwzeallnr4vcanvaeti-story.html"
    ...
    def test_date_in_meta_tags(self):
        url = "https://web.archive.org/web/https://www.foxnews.com/politics/biden-cancel-school-loans-corinthian-college-students"
        raw_html, response = webpages.fetch(url)
        pub_date = dates.guess_publication_date(raw_html, url)
    ...
    def test_day_month_year(self):
        u = "https://web.archive.org/web/https://www.eeas.europa.eu/eeas/eu-world-0_en"
        raw_html, response = webpages.fetch(u)
        date = dates.guess_publication_date(raw_html, u)
    ...
    def test_real_date1(self):
        u = "https://web.archive.org/web/https://www.atv.hu/belfold/20190730/gyarfas-ugyvedje-aki-a-vadiratot-alkotta-nem-biztos-hogy-az-ugy-minden-reszletet-megismerte"
        raw_html, response = webpages.fetch(u)
        date = dates.guess_publication_date(raw_html, u)
