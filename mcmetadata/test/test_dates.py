...
from .. import guess_publication_date
...
class TestDates(unittest.TestCase):
    ...
    def test_date_subhead(self):
        ...
        pub_date = guess_publication_date(raw_html, u)
    ...
    def test_date_in_url(self):
        ...
        pub_date = guess_publication_date(raw_html, url)
    ...
    def test_ignore_footer_copyright(self):
        ...
        for u in urls:
            raw_html, response = webpages.fetch(u)
            date = guess_publication_date(raw_html, u)
            assert date is None
    ...
    def test_max_date(self):
        ...
        date = guess_publication_date(raw_html, u, max_date=dt.datetime(2020, 1, 1))
        assert date is None
